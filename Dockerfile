...
FROM xychelsea/anaconda3:v0.4-gpu
...
# Build ffmpeg
RUN cd ~ \
    && wget -O ~/ffmpeg-${FFMPEG_VERSION}.tar.gz https://ffmpeg.org/releases/ffmpeg-${FFMPEG_VERSION}.tar.gz \
...
RUN cd /home/anaconda/ffmpeg-${FFMPEG_VERSION} \
   && make install
